...
export async function POST(request: Request) {
  try {
    ...
    const action = body.action === "regenerate" ? "regenerate" : body.action === "first_message" ? "first_message" : "";
